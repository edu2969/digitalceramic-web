...
## Corpus Check
- 105 files · ~1,341,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 532 nodes · 768 edges · 37 communities (26 shown, 11 thin omitted)
...
- `GET()` --calls--> `isEstado()`  [EXTRACTED]
  app/api/dashboard/route.ts → lib/estado.ts
...
Cohesion: 0.10
Nodes (35): ColorSectionEditor(), PieceCard(), SECTION_LABELS, PieceCardProps, getAdjacentPieces(), isExtremePiece(), StepPieceSelection(), StepSend() (+27 more)
...
Cohesion: 0.17
Nodes (16): ageFromBirthDate(), ALLOWED_TRANSITIONS, daysDiff(), formatDateLong(), formatTooth(), GET(), MONTHS_ES_LONG, PALETTE_LABEL (+8 more)
...
Cohesion: 0.16
Nodes (16): WorkDetail, Dashboard(), DashboardResponse, DashboardStats, fetchDashboard(), PieceType, typeStyles, WorkItem (+8 more)

### Community 7 - "AutoField.tsx"
Cohesion: 0.06
Nodes (29): AutoTextarea(), AutoTextareaProps, useAutoSaveContext(), AutoSavePayload, Options, SaveFn, useAutoSaveEngine(), usePieceAutoSave() (+21 more)
...
Cohesion: 0.18
Nodes (7): Option, Props, fetchProfile(), ProfileResponse, StepBasicInformation(), AutocompleteOption, splitFullName()
...
### Community 25 - "Caso.tsx"
Cohesion: 0.19
Nodes (8): fetchWork(), Transition, transitionFor(), transitionPagoFor(), WorkColor, WorkFile, WorkPagePage(), WorkPiece
...
Cohesion: 0.29
Nodes (9): formatDate(), fullName(), GET(), mm(), MONTHS_ES, supabase, TrabajoRow, TYPE_LABEL (+1 more)

### Community 36 - "route.ts"
Cohesion: 0.32
Nodes (7): daysDiff(), formatDate(), GET(), MONTHS_ES, supabase, TrabajoRow, TYPE_LABEL
...
- **Why does `createClient()` connect `createClient` to `Perfil.tsx`, `route.ts`, `route.ts`, `route.ts`, `route.ts`, `route.ts`, `QueryProvider.tsx`, `route.ts`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `Estado` connect `Caso.tsx` to `route.ts`, `Caso.tsx`, `route.ts`, `route.ts`?**
