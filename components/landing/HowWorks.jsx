  ...
  return (<section className="py-6 px-6 max-w-7xl mx-auto text-center border-2 border-gray-100 mt-4 bg-[#F3F2F5]">
    ...
    <div className="grid md:grid-cols-4 gap-8 mt-10">
      <div className="w-full text-center border-gray-200 border-r-2 px-4">
        <Image src="/tool_3_01.png" width={85} height={93} className="mx-auto w-22.5 h-auto" alt="tool 301" />
      ...
      <div className="w-full text-center border-gray-200 border-r-2 px-4">
        <Image src="/tool_3_02.png" width={132} height={99} className="mx-auto my-5 w-22.5 h-auto" alt="tool 302" />
        <p className="text-gray-600 mt-2 font-bold">
          FLujo 100% digital
        </p>
      ...
      <div className="w-full text-center border-gray-200 border-r-2 px-4 mt-5">
        <Image src="/tool_3_03.png" width={130} height={103} className="mx-auto mb-4 w-22.5 h-auto" alt="tool 303" />
        <p className="text-gray-600 mt-2 font-bold">
      ...
      <div className="w-full text-center border-gray-200 border-r-2 px-4">
        <Image src="/tool_3_04.png" width={92} height={84} className="mx-auto my-3 w-22.5 h-auto" alt="tool 304" />
        <p className="text-gray-600 mt-2 font-bold">
