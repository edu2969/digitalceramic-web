  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl bg-[#F5F9FF] border border-[#D9E5F3] p-8 text-center">
        <div className="rounded-3xl bg-linear-to-br from-[#F5F9FF] to-[#E8F0FE] border border-[#D9E5F3] shadow-sm overflow-hidden">
          {/* Header del resumen */}
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex flex-col items-end">
                            <span className="font-bold text-[#0A1330]">
                              ${(esDescuento ? PRECIOS.DESCUENTO : PRECIOS.NORMAL).toLocaleString()}
                            </span>
                            {esDescuento && (
